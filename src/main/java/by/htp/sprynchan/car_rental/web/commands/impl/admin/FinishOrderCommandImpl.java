...
public class FinishOrderCommandImpl implements BaseCommand {
	
	private static final String MESSAGE_VALUE = "success_finish_order";
	...
	public String executeCommand(HttpServletRequest request) throws CommandException {	
		...
		if (validatePositiveInt(orderId)) {
			orderService.updateOrderStatus(formatInt(orderId), OrderStatusEnum.FINISHED);
